  ...
  return (
    ...
    >
      <div className="flex justify-between items-center">
        {}
        <img src="/din.png" alt="Din Logo" className="h-8 w-8 mr-2" />

        <Link href="/" className="text-xl font-bold">
          Dinamik<span className="text-blue-600 font-extrabold">18</span>
        </Link>
        <img src="/diki.png" alt="Cowo Logo" className="h-9 w-9 mr-2" />
